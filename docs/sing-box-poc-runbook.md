...
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmFactsCommand > $VmFactsPath
$VmFactsSucceeded = $?
$VmFactsExitCode = $LASTEXITCODE
if (-not $VmFactsSucceeded -or $VmFactsExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmFactsCommand > $VmFactsPath failed to launch or exited with code $VmFactsExitCode.' }
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmBaselineCommand > $VmBaselinePath
$VmBaselineSucceeded = $?
$VmBaselineExitCode = $LASTEXITCODE
if (-not $VmBaselineSucceeded -or $VmBaselineExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmBaselineCommand > $VmBaselinePath failed to launch or exited with code $VmBaselineExitCode.' }
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $TelecomConnectCommand > $TelecomConnectPath
$TelecomConnectSucceeded = $?
$TelecomConnectExitCode = $LASTEXITCODE
if (-not $TelecomConnectSucceeded -or $TelecomConnectExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $TelecomConnectCommand > $TelecomConnectPath failed to launch or exited with code $TelecomConnectExitCode.' }
```
...
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmCanonicalStateCommand > $VmWhatIfBeforePath
$VmWhatIfBeforeSucceeded = $?
$VmWhatIfBeforeExitCode = $LASTEXITCODE
if (-not $VmWhatIfBeforeSucceeded -or $VmWhatIfBeforeExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmCanonicalStateCommand > $VmWhatIfBeforePath failed to launch or exited with code $VmWhatIfBeforeExitCode.' }
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerWhatIfCommand > $ServerWhatIfPath
$ServerWhatIfSucceeded = $?
$ServerWhatIfExitCode = $LASTEXITCODE
if (-not $ServerWhatIfSucceeded -or $ServerWhatIfExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerWhatIfCommand > $ServerWhatIfPath failed to launch or exited with code $ServerWhatIfExitCode.' }
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmCanonicalStateCommand > $VmWhatIfAfterPath
$VmWhatIfAfterSucceeded = $?
$VmWhatIfAfterExitCode = $LASTEXITCODE
if (-not $VmWhatIfAfterSucceeded -or $VmWhatIfAfterExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmCanonicalStateCommand > $VmWhatIfAfterPath failed to launch or exited with code $VmWhatIfAfterExitCode.' }
...
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmBaselineCommand > $VmPreInstallPath
$VmPreInstallSucceeded = $?
$VmPreInstallExitCode = $LASTEXITCODE
if (-not $VmPreInstallSucceeded -or $VmPreInstallExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $VmBaselineCommand > $VmPreInstallPath failed to launch or exited with code $VmPreInstallExitCode.' }
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerInstallCommand > $ServerInstallPath
$ServerInstallSucceeded = $?
$ServerInstallExitCode = $LASTEXITCODE
if (-not $ServerInstallSucceeded -or $ServerInstallExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerInstallCommand > $ServerInstallPath failed to launch or exited with code $ServerInstallExitCode.' }
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerStatusCommand > $ServerStatusPath
$ServerStatusSucceeded = $?
$ServerStatusExitCode = $LASTEXITCODE
if (-not $ServerStatusSucceeded -or $ServerStatusExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerStatusCommand > $ServerStatusPath failed to launch or exited with code $ServerStatusExitCode.' }
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerAttestationCommand > $ServerAttestationPath
$ServerAttestationSucceeded = $?
$ServerAttestationExitCode = $LASTEXITCODE
if (-not $ServerAttestationSucceeded -or $ServerAttestationExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerAttestationCommand > $ServerAttestationPath failed to launch or exited with code $ServerAttestationExitCode.' }
...
```powershell
& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerRollbackCommand > $ServerRollbackPath
$ServerRollbackSucceeded = $?
$ServerRollbackExitCode = $LASTEXITCODE
if (-not $ServerRollbackSucceeded -or $ServerRollbackExitCode -ne 0) { throw '& ssh.exe -F NUL -o BatchMode=yes -o StrictHostKeyChecking=yes -o HostKeyAlgorithms=ssh-ed25519 -o UserKnownHostsFile=$KnownHostsPath -o GlobalKnownHostsFile=NUL -o VerifyHostKeyDNS=no -o UpdateHostKeys=no $VmSshTarget $ServerRollbackCommand > $ServerRollbackPath failed to launch or exited with code $ServerRollbackExitCode.' }
```
